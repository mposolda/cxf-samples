package org.apache.cxf.samples.sec.client;

import org.apache.cxf.jaxws.JaxWsProxyFactoryBean;
import org.apache.cxf.samples.sec.Person;
import org.apache.cxf.samples.sec.UnknownPersonFault;
...
public final class Client {
    ...
    public static void main(String args[]) throws Exception {
        ...
        if (args != null && args.length > 0 && !"".equals(args[0])) {
            ...
            factory.setAddress("http://localhost:8181/cxf/PersonServiceCF-sec");
        }
